...
export const SecondBar = () => {
    return <div className="sticky w-screen top-0 z-50 bg-stone-300 backdrop-blur-xl border-b-stone-400 border-b-2 px-4 py-2 md:px-8 md:py-5 flex justify-between items-center">
