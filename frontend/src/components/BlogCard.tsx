...
export const BlogCard = ({
    ...
    <div className="p-4 border-b border-slate-200 pb-4 w-screen max-w-screen-md cursor-pointer">
        <div className="flex">
            ...
            <div className="font-semibold pl-2  text-slate-800 text-xs md:text-sm lg:text-md flex justify-center flex-col">{authorName}</div>
            <div className="flex justify-center flex-col pl-2">
                <Circle />
            </div>
            <div className="pl-2 font-semibold text-slate-800 text-xs md:text-sm lg:text-mdg flex justify-center flex-col">
                {publishedDate}
            </div>
        </div>
...
export function Avatar({ name }: { name: string }) {
    return (
        <div className="relative inline-flex items-center justify-center w-5 h-5 md:w-6 md:h-6 lg:w-7 lg:h-7 overflow-hidden bg-slate-900 rounded-full">
